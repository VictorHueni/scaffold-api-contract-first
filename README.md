...
| [`docs/`](docs/) | Project documentation: how-to guides, reference catalogs, product specs, execution plans, and the slide deck. Start at [`docs/README.md`](docs/README.md). |
...
| **Present this to your team** | [`docs/slide-decks/api-first-demo-structure.md`](docs/slide-decks/api-first-demo-structure.md) — narrative arc, slide outline, talking points |
