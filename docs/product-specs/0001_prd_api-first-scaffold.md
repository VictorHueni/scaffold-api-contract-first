...
*Video recording and slide production are covered in the [Presentation & Delivery Guide](../slide-decks/api-first-demo-structure.md), not in this PRD. This PRD covers the scaffold implementation only.*
